---
alwaysApply: true
description: zyron-reasoning cognitive governance layer — mandatory reasoning protocol for every request
---
...
- This rule has `alwaysApply: true`. It applies to every request without exception.
